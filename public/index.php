    ...
    if (isset($_POST['laheta'])) {
      ...
      if (tarkistaKirjautuminen($_POST['email'],$_POST['salasana'])) {
        ...
        if ($user['vahvistettu']) {
          ...
          echo $templates->render('kirjaudu', [ 'error' => ['virhe' => 'Hups, tilisi taitaa olla vielä vahvistamatta! Ole hyvä, ja vahvista tili sähköpostissa olevalla linkillä.']]);
        }
      } else {
        echo $templates->render('kirjaudu', [ 'error' => ['virhe' => 'Sori, väärä käyttäjätunnus tai salasana!']]);
      }
    } else {
